...
*   **1.1:** В расширении должен быть создан **справочник или регистр "Настройки обмена с сайтом"** для хранения параметров по умолчанию. Он уже определен, с  наименованием.
...
*   **3.2:** Реквизиты Сделки заполняются следующим образом:
    ...
    *   **Комментарий:** `"Загружено с сайта. "` И все доступные значения сайта.
